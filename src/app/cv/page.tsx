        ...
        <div className="container-page">
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-12 lg:items-start">
            ...
            <div className="lg:col-span-8">
              <div className="grid gap-4 sm:grid-cols-2">
                {sections.map((s) => (
                  <SectionReveal
                    ...
                    whileInView={{ opacity: 1, y: 0, scale: 1 }}
                  >
                    <div className="card card-hover p-6 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-lg">
              ...
              <SectionReveal duration={0.6} y={12}>
                      ...
                      >
                        <div className="relative">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 rounded-2xl border border-border bg-background p-4 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-sm sm:p-5">
              ...
              <SectionReveal duration={0.6} y={12} delay={0.05}>
                <div className="mt-6 rounded-3xl border border-border bg-surface p-6 sm:p-7">
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row">
                      <Link
                        href="/book"
                        className="btn-accent justify-center transition-all duration-300 ease-out hover:-translate-y-0.5 hover:scale-[1.01] hover:shadow-md active:scale-[0.99]"
                      >
                        احجز موعد
                      </Link>
                      <Link
                        href="/contact"
                        className="btn-primary justify-center transition-all duration-300 ease-out hover:-translate-y-0.5 hover:scale-[1.01] hover:shadow-md active:scale-[0.99]"
                      >
                        تواصل معنا
                      </Link>
                    </div>
